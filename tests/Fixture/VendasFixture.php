...
class VendasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_users_11_idx' => ['type' => 'index', 'columns' => ['vendedor_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'vend' => ['type' => 'foreign', 'columns' => ['vendedor_id'], 'references' => ['vendedores', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'created' => '2019-12-05 14:16:31',
                'modified' => '2019-12-05 14:16:31',
                'vendedor_id' => 1,
                'peso' => 1,
                'valor' => 1.5,
                'delivery' => 1,
                'horario' => '2019-12-05 14:16:31'
            ],
        ];
        parent::init();
    }
