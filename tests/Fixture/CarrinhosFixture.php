...
class CarrinhosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_users_1000_idx' => ['type' => 'index', 'columns' => ['vendedor_id'], 'length' => []],
            'fk_carrinhos_1_idx' => ['type' => 'index', 'columns' => ['usuario_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_carrinhosaa' => ['type' => 'foreign', 'columns' => ['usuario_id'], 'references' => ['usuarios', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_users_aa' => ['type' => 'foreign', 'columns' => ['vendedor_id'], 'references' => ['vendedores', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'created' => '2019-12-05 14:16:43',
                'modified' => '2019-12-05 14:16:43',
                'vendedor_id' => 1,
                'usuario_id' => 1,
                'total' => 1.5,
                'tipo' => 1
