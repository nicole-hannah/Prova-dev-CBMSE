...
class UsuariosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'fk_users_1' => ['type' => 'foreign', 'columns' => ['ponto_id'], 'references' => ['pontos', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'created' => '2019-12-05 14:16:00',
                'modified' => '2019-12-05 14:16:00',
                'ponto_id' => 1,
