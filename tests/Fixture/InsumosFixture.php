...
class InsumosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'ponto_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'fk_users_1_idx' => ['type' => 'index', 'columns' => ['ponto_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_users_100' => ['type' => 'foreign', 'columns' => ['ponto_id'], 'references' => ['pontos', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'created' => '2019-12-05 14:15:50',
                'modified' => '2019-12-05 14:15:50',
                'ponto_id' => 1,
