                ...
                <div class="login-form-center">
                    <div class="login-data">
                        ...
                        <div class="login-field">
                            <form id="contato" action="/editar-contato/<?=$contato->id?>" method="post" style="">
                                <div class="login-title text-center">
                                    <h5><b>Editar Contato</b></h5>
                                </div>
                                ...
                                <div class="tamanho-select form-group wow fadeInLeft animated" data-wow-delay="0.5s">
                                    ...
                                    <select id="tipos" name="tipo" class="input-field ">
                                        ...
                                        <?php foreach ($tipos as $tipo){
                                            if($tipo->id == $contato->tipo_contato_id){?>
                                ...
                                <div class="tamanho-select form-group wow fadeInLeft animated" data-wow-delay="0.5s">
                                    ...
                                    <input type="text" required id="contato-input" class="mascara input-field" value="<?=$contato->contato?>"  name="contato" placeholder="Contato">
                                </div>
